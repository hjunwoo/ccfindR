...
of count data and factorizes the data matrix $\sf X$ into two matrices 
...
Expected file names are `matrix.mtx`, `genes.tsv`, 
and `barcodes.tsv` for the count, gene, and
cell annotations, respectively. The function returns an `scNMFSet` object. 
...
```{r, cache=T, echo=T, fig.width=4, fig.height=4, fig.cap='Additional selection of genes with modes at nonzero counts. Symbols in blue represent genes rescued.'}
...
```{r}
cell_type <- c('CD8+_T','NK','Monocytes','B_cell','CD4+_T')
