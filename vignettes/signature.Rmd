...
used by other implementations of signature analysis 
[@gehring_etal,@ardin_etal],
...
function `trinucleotideMatrix()` in the package [`maftools`](https://bioconductor.org/packages/release/bioc/vignettes/maftools/inst/doc/maftools.html). We added the capability of considering 5-mers (1,536 rows) 
